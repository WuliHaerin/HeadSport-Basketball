...
public class GameManager : MonoBehaviour
{
    ...
    public TMP_Text p1ShotCountLabel, p2ShotCountLabel;

    public TMP_Text timeLabel;
    public TMP_Text p1ScoreLabel, p2ScoreLabel;
        ...
        if (gameMode == GameMode.PLAY)
        {
            ...
            else
            {
                    ...
                    if (p1Score < p2Score)
                    {
                        ...
                        gameOverMenu.transform.GetChild(2).GetComponent<TextMeshPro>().text = p2Name.text + " 赢";
                    ...
                    else if (p1Score > p2Score)
                    {
                        ...
                        gameOverMenu.transform.GetChild(2).GetComponent<TextMeshPro>().text = p1Name.text + " 赢";
    ...
    public void SetGameUnActive()
    {
        if(!isContinue)
        {
            ...
            gameOverMenu.transform.GetChild(0).GetChild(5).GetComponent<TextMeshPro>().text = p1Name.text;
            gameOverMenu.transform.GetChild(0).GetChild(6).GetComponent<Renderer>().sortingOrder = 15;
            gameOverMenu.transform.GetChild(0).GetChild(6).GetComponent<TextMeshPro>().text = p1Score.ToString();
            ...
            gameOverMenu.transform.GetChild(1).GetChild(5).GetComponent<TextMeshPro>().text = p2Name.text;
            gameOverMenu.transform.GetChild(1).GetChild(6).GetComponent<Renderer>().sortingOrder = 15;
            gameOverMenu.transform.GetChild(1).GetChild(6).GetComponent<TextMeshPro>().text = p2Score.ToString();
            SetGAmeOverMenuTrue();
        }
    }
